...
## 🇮🇩 Bahasa Indonesia
Repo ini berisi:
- **CV** → Curriculum Vitae dalam format PDF
- **Portfolio** → Kumpulan project analisis data (Business Problem, Statistics, SQL, Python, Visualization, Final Project)

## 🇬🇧 English
This repository contains:
- **CV** → Curriculum Vitae in PDF format
- **Portfolio** → Collection of data analysis projects (Business Problem, Statistics, SQL, Python, Visualization, Final Project)
