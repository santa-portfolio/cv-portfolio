...
## 📌 Notes / Catatan
- Semua file di folder ini berfungsi sebagai **referensi dan data pendukung** untuk analisis Python.  
- Notebook dapat dijalankan di Google Colab atau Jupyter Notebook untuk melihat kode, visualisasi, dan hasil analisis.  
- PDF berfungsi sebagai dokumentasi ringkas untuk recruiter atau stakeholder.  

---

## 🔗 Navigasi Tambahan
- [Kembali ke Portfolio](../README.md)  
- [Business Problem](../01_business_problem/)  
- [Statistics Spreadsheets](../02_statistics_spreadsheets/)  
